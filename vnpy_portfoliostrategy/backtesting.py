...
class PortfolioDailyResult:
    ...
    def add_trade2(self, trade: TradeData) -> None:
        """"""
        if trade.vt_symbol in self.contract_results:
    ...
    # def add_trade(self, trade: TradeData) -> None:
    #     """"""
    #     if trade.vt_symbol not in self.contract_results:
    #         self.contract_results[trade.vt_symbol] = ContractDailyResult(self.date, trade.price)
    #     contract_result = self.contract_results[trade.vt_symbol]
    #     contract_result.add_trade(trade)
